...
<div class="navbar">
        ...
        <!-- LOGO ONLY -->
        <div class="nav_left">
            <img src="<%= request.getContextPath() %>/ui/assets/images/worklog_logo.png" class="nav_logo" alt="worklog">
        </div>
		...
		<div class="navbar_menu" onclick="showMenu()">
	            <img alt="Menu" src="<%=request.getContextPath()%>/ui/assets/icons/hamburger-menu.svg">
        </div>
